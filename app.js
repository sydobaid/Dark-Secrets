...
// Removing becuase we are using level 5 security
const app = express();
...
mongoose.set('useCreateIndex', true); // TO avoid the deprication warning
...
// Commenting the above line because now we are using hashing
...
passport.use(new GoogleStrategy({
  ...
  function(accessToken, refreshToken, profile, cb) {
    console.log(profile); // For better understanding the concept. We can access many things from profile.
